...
class Booking:
    def __init__(self, id: int, start_date: str, end_date: str, user_id: int, space_id: int):
        self.id = id
    ...
    def __repr__(self):
        return (
            f"Booking(ID: {self.id}, Requested Dates: {self.requested_dates}, Customer User ID: {self.user_id}, Space ID: {self.space_id})"
        )
    ...
    @classmethod
    def from_database(cls, id: int, requested_dates: str, user_id: int, space_id: int):
